...
var ASM_CONSTS = {
  ...
  function _emscripten_websocket_send_binary(socketId, binaryData, dataLength) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(4, 1, socketId, binaryData, dataLength);
  ...
  function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(6, 1, fd, offset_low, offset_high, whence, newOffset);
...
var proxiedFunctionTable = [null,_proc_exit,exitOnMainThread,pthreadCreateProxied,_emscripten_websocket_send_binary,_fd_close,_fd_seek,_fd_write];
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 3229032;
